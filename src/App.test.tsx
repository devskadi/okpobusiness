...
describe('OkPo role workspaces', () => {
  ...
  it('opens a campaign page with submissions, missions, and leaderboard tabs', async () => {
    ...
    expect(screen.getByText('Madrid PH')).toBeInTheDocument()
    expect(screen.getByText('Madrid HR')).toBeInTheDocument()
    expect(screen.getByText('TICP')).toBeInTheDocument()
    expect(screen.queryByText('Madrid Field')).not.toBeInTheDocument()
    expect(screen.queryByText('CEPAT Creators')).not.toBeInTheDocument()
